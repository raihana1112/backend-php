            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Settings Akun</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Settings Akun</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
                                    ...
                                    <div class="col-sm-3 mb-3 mb-sm-0"><label for="">Username</label>
                                        <input class="form-control form-control-solid" name="username" type="text" value="<?php echo $d['username']; ?>" required>
                                    </div>
                                    <div class="col-sm-3 mb-3 mb-sm-0"><label for="">Password</label>
                                        <input class="form-control form-control-solid" name="password" type="text" value="<?php echo $d['password']; ?>" required>
                                    </div>
